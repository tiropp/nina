...
RUN \
    ...
    make qtbase_CONFIGURE_OPTS="-debug-and-release -no-opengl" qtdeclarative qtquickcontrols qtquickcontrols2 qtsvg -j MXE_TARGETS='x86_64-w64-mingw32.shared'
